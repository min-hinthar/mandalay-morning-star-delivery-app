...
4. Run full build verification:
   ...
   <verify>
5. `grep -rn "zClass" src/components/ui/dropdown-menu.tsx` shows import and usage
6. `grep -rn "zClass" src/components/layouts/AdminLayout.tsx` shows import and usage
7. `grep -rn "zClass" src/components/ui-v8/menu/SearchAutocomplete.tsx` shows import and usage
8. `pnpm build` completes successfully
   </verify>
