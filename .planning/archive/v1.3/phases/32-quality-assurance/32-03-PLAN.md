...
3. Verify baseline images created in e2e/**snapshots**/ or e2e/visual-regression.spec.ts-snapshots/
   </verify>
...
- lint-staged config in package.json targets src/\*_/_.{ts,tsx,css}
