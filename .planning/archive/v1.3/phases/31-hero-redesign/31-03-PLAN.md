...
export const HERO_EMOJIS = ["🍜", "🥟", "🍲", "🌶️"] as const;
...
export const EMOJI_CONFIG: Omit<FloatingEmojiProps, "parallaxY" | "mouseOffset" | "index">[] = [
  ...
  { emoji: "🍜", size: "sm", depth: "far", animationType: "drift", initialX: 10, initialY: 15 },
  { emoji: "🥟", size: "sm", depth: "far", animationType: "bob", initialX: 85, initialY: 25 },
  { emoji: "🍲", size: "sm", depth: "far", animationType: "spiral", initialX: 25, initialY: 70 },
  { emoji: "🌶️", size: "sm", depth: "far", animationType: "drift", initialX: 70, initialY: 80 },
  // Mid layer (medium)
  { emoji: "🥟", size: "md", depth: "mid", animationType: "spiral", initialX: 5, initialY: 45 },
  { emoji: "🍜", size: "md", depth: "mid", animationType: "drift", initialX: 90, initialY: 55 },
  { emoji: "🌶️", size: "md", depth: "mid", animationType: "bob", initialX: 35, initialY: 20 },
  { emoji: "🍲", size: "md", depth: "mid", animationType: "spiral", initialX: 60, initialY: 75 },
  { emoji: "🥟", size: "md", depth: "mid", animationType: "drift", initialX: 80, initialY: 10 },
  // Near layer (large, crisp)
  { emoji: "🍜", size: "lg", depth: "near", animationType: "bob", initialX: 15, initialY: 60 },
  { emoji: "🍲", size: "lg", depth: "near", animationType: "spiral", initialX: 75, initialY: 40 },
  { emoji: "🌶️", size: "lg", depth: "near", animationType: "drift", initialX: 45, initialY: 85 },
  { emoji: "🥟", size: "lg", depth: "near", animationType: "bob", initialX: 55, initialY: 15 },
];
```
