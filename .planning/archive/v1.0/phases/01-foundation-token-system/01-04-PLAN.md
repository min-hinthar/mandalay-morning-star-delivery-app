...
The CSS variables in globals.css @theme block are --z-index-_ (TailwindCSS 4 strips the prefix to generate z-_ utilities, but the raw CSS variables retain the full name).
</action>
<verify>
