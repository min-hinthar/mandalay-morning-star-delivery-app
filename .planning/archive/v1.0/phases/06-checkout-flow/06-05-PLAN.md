...
>
  ...
  <motion.div variants={staggerItem}>{/* Order summary card */}</motion.div>
  <motion.div variants={staggerItem}>{/* Delivery info cards */}</motion.div>
  <motion.div variants={staggerItem}>{/* Action buttons */}</motion.div>
</motion.div>
```
...
return (
  <>
    ...
    <div className="min-h-screen bg-gradient-to-b ...">{/* rest of content */}</div>
  </>
);
```
