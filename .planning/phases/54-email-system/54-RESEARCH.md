...
import {
  ...
  Heading, Text, Button, Img, Link, Hr, Preview,
...
function mapTypeToPrefKey(type: EmailType): keyof NotificationPrefs {
  switch (type) {
    case 'order_confirmation': return 'order_updates';  // mandatory, skip check
    case 'cancellation': return 'order_updates';
    case 'refund': return 'order_updates';               // mandatory, skip check
    case 'delivery_reminder': return 'reminders';
    default: return 'order_updates';
  }
}
