...
must_haves:
  truths:
    ...
    - "Components can use z-modal utility instead of arbitrary z-index values"
  artifacts:
...
Purpose: Enable first-class TailwindCSS utilities (z-modal) and provide type-safe z-index constants for inline styles.
