...
const FIX_SUGGESTIONS = {
  ...
  'text-[#hex]': 'text-[var(--color-*)] with semantic token',
  'bg-[#hex]': 'bg-[var(--color-*)] with semantic token',
  'border-[#hex]': 'border-[var(--color-*)] with semantic token',
  'inline color:#hex': 'Use CSS variable: color: var(--color-*)',
  'inline bg:#hex': 'Use CSS variable: backgroundColor: var(--color-*)',
  'inline color:rgb()': 'Use CSS variable: color: var(--color-*)',
  'inline bg:rgb()': 'Use CSS variable: backgroundColor: var(--color-*)',
