-- ===========================================
-- Order Contact Info (customer_phone + customer_name)
--
-- 1. Add customer_phone and customer_name columns to orders
-- 2. Update create_order_with_items RPC to accept new fields
-- ===========================================

-- ===========================================
-- 1. ADD CONTACT COLUMNS TO ORDERS
-- ===========================================
...
-- ===========================================
-- 2. UPDATE create_order_with_items RPC
-- Now accepts customer_phone and customer_name
-- ===========================================
