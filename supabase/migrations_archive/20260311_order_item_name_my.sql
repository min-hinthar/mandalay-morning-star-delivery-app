-- ===========================================
-- Add Myanmar name snapshot to order_items
--
-- 1. Add name_my_snapshot column
-- 2. Update create_order_with_items RPC to insert it
-- ===========================================
...
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS name_my_snapshot TEXT;

-- ===========================================
-- 2. UPDATE create_order_with_items RPC
-- Now inserts name_my_snapshot for order items
-- ===========================================
