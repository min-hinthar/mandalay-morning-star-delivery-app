...
export function RoutesStatsCards({
  ...
  return (
    ...
    >
      ...
      {/* Planned */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-50 to-gray-100/50 border border-gray-200/50 p-4 shadow-sm">
        <div className="absolute top-0 right-0 w-20 h-20 bg-gray-100 rounded-full -translate-y-1/2 translate-x-1/2" />
        <div className="relative">
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200/50 p-4 shadow-sm">
        ...
        <div className="relative">
          ...
          <p className="text-3xl font-display text-charcoal mt-2">{assigned}</p>
        </div>
      </div>

      {/* Accepted */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200/50 p-4 shadow-sm">
        <div className="absolute top-0 right-0 w-20 h-20 bg-green-100 rounded-full -translate-y-1/2 translate-x-1/2" />
        <div className="relative">
          <div className="flex items-center gap-2 text-green-600">
            <ThumbsUp className="h-5 w-5" />
            <span className="text-sm font-medium">Accepted</span>
          </div>
          <p className="text-3xl font-display text-charcoal mt-2">{accepted}</p>
        </div>
      </div>
