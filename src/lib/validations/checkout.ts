...
// Structural validation only — time window business logic validation
// (checking against dynamically generated windows from getBusinessRules())
// happens in the checkout route handler where DB values are available.
