...
export interface CategoryCarouselV7Props {
    ...
    >
      ...
      {isActive && (
        <motion.div
          ...
          className="absolute inset-0 rounded-full bg-v6-primary shadow-lg"
          initial={false}
          transition={shouldAnimate ? getSpring(v7Spring.snappy) : { duration: 0 }}
          style={{
      ...
      {!isActive && (
        <div className="absolute inset-0 rounded-full bg-v6-surface-secondary opacity-0 group-hover:opacity-100 transition-opacity" />
      )}
...
export function CategoryCarouselV7({
  categories,
  activeCategory,
  onCategoryClick,
  className,
...
export default CategoryCarouselV7;
