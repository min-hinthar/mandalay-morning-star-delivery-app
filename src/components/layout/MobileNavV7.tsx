...
export interface MobileNavV7Props {
    ...
    >
      {infoItems.map((item, index) => (
        <motion.div
          ...
          transition={getSpring(v7Spring.snappy)}
        >
          <span className="text-v6-secondary">{item.icon}</span>
          <span>{item.text}</span>
          <span className="text-v6-primary font-medium">{item.highlight}</span>
        </motion.div>
      ))}
    </motion.div>
  );
        ...
        <>
          ...
          >
            ...
            <div className="p-4 border-b border-neutral-100">
              {user ? (
                <motion.div
                  ...
                  transition={{ delay: 0.1, ...getSpring(v7Spring.gentle) }}
                >
                  {/* Avatar */}
                  <motion.div
                    className={cn(
                      "w-12 h-12 rounded-xl overflow-hidden",
                      "bg-gradient-to-br from-v6-primary to-v6-secondary",
                ...
                >
                  <Link
                    ...
                    className={cn(
                      ...
                      "bg-v6-primary text-white font-medium",
                      "hover:bg-v6-primary-hover transition-colors"
                    )}
                  >
            ...
            <motion.div
              ...
              variants={v7StaggerContainer(0.08, 0.15)}
              initial="hidden"
              animate="visible"
              exit="exit"
            >
