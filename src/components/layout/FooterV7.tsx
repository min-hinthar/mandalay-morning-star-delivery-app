...
export interface FooterV7Props {
  /** Business info */
  businessInfo?: {
    name?: string;
    address?: string;
    ...
    <div className="max-w-md mx-auto">
      ...
      <AnimatePresence mode="wait">
        {isSubmitted ? (
          <motion.div
            key="success"
            className="flex items-center gap-2 text-v6-green"
          ...
          >
            ...
            <motion.button
              ...
              className={cn(
                ...
                "hover:bg-v6-secondary-hover transition-colors",
                "disabled:opacity-50"
              )}
          ...
          >
            ...
            <div className="space-y-2 text-white/60 text-sm">
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-v6-secondary" />
                <span>{businessInfo.address}</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4 text-v6-secondary" />
                <span>{businessInfo.hours}</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-v6-secondary" />
                <span>{businessInfo.phone}</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-v6-secondary" />
