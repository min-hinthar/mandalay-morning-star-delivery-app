...
export function HowItWorksTimeline() {
  ...
  return (
    <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-surface-secondary/50 to-surface-primary">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-body font-medium text-primary">How It Works</span>
          </motion.div>
          ...
          <motion.p variants={v6StaggerItem} className="font-body text-text-secondary max-w-2xl mx-auto">
        ...
        >
          <div className="relative">
            {/* Connection Line */}
            <div className="absolute top-14 left-0 right-0 h-1 bg-gradient-to-r from-primary via-secondary via-green to-accent-orange rounded-full" />
            ...
            <div className="grid grid-cols-4 gap-4">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="relative z-dropdown mb-6">
                    <motion.div
                      ...
                      className={cn(
                        ...
                        "bg-surface-primary shadow-card border-4 border-surface-primary",
                        step.bgColor
                      )}
                    >
                    ...
                    <div
                      className={cn(
                        ...
                        "flex items-center justify-center font-body font-bold text-sm shadow-md",
                        index === 0 && "bg-primary text-white",
                        index === 1 && "bg-secondary text-text-primary",
                        index === 2 && "bg-green text-white",
                        index === 3 && "bg-accent-orange text-white"
                      )}
                    >
                      {index + 1}
                    </div>
                  ...
                  <p className="font-body font-medium text-text-primary mb-1">{step.description}</p>
                  <p className="text-sm font-body text-text-muted">{step.detail}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        >
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-primary via-secondary via-green to-accent-orange rounded-full" />
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="relative z-dropdown flex-shrink-0">
                    <div
                      className={cn(
                        ...
                        "bg-surface-primary shadow-md border-2 border-border",
                        step.bgColor
                      )}
                    >
                    ...
                    <div
                      className={cn(
                        ...
                        "flex items-center justify-center font-body font-bold text-xs shadow-sm",
                        index === 0 && "bg-primary text-white",
                        index === 1 && "bg-secondary text-text-primary",
                        index === 2 && "bg-green text-white",
                        index === 3 && "bg-accent-orange text-white"
                  ...
                  <div className="pt-2">
                    ...
                    <p className="text-xs font-body text-text-muted">{step.detail}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-4 bg-surface-primary rounded-card shadow-card border border-border">
            ...
            <div className="text-left">
              <p className="font-body font-semibold text-text-primary">Weekly Cutoff: Friday 3:00 PM PT</p>
