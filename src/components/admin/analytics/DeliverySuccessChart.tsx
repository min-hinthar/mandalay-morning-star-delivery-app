        ...
        <ResponsiveContainer width="100%" height={height}>
          <BarChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            ...
            <Legend
              ...
              iconSize={8}
              formatter={(value) => (
                <span className="text-xs text-charcoal-600 capitalize">
                  {value}
                </span>
              )}
            />
...
export function ETAAccuracyGauge({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center rounded-xl bg-white p-6 shadow-warm-sm"
    >
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-2">
          <motion.span
            ...
            className="text-4xl font-bold text-charcoal-900"
          >
            {percentage}%
          </motion.span>
          {trend !== 0 && (
            <motion.span
              ...
              className={`text-sm font-medium ${
                trend > 0 ? "text-jade" : "text-red-500"
              }`}
            >
              {trend > 0 ? "+" : ""}
              {trend.toFixed(1)}%
