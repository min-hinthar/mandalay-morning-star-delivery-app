      ...
      <div className="flex items-center justify-between rounded-lg bg-[var(--color-surface)] sm:bg-[var(--color-surface)]/90 px-3 py-2 shadow-sm sm:backdrop-blur-sm">
        <div className="flex items-center gap-4 text-xs">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[var(--color-text-primary)]">Destination</span>
          </div>
          {showDriverMarker && (
            <div className="flex items-center gap-1.5">
          ...
          {showRestaurantMarker && (
            <div className="flex items-center gap-1.5">
              <div className="h-3 w-3 rounded-full" style={{ backgroundColor: "#C75050" }} />
              <span className="text-[var(--color-text-primary)]">Restaurant</span>
            </div>
          )}
        </div>
