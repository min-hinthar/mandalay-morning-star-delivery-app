...
export function TooltipContent({
  ...
  return (
    <span
      className={cn(
        "pointer-events-none absolute left-1/2 top-full z-50 w-max -translate-x-1/2 rounded-md bg-foreground px-2 py-1 text-xs text-background opacity-0 shadow-md",
