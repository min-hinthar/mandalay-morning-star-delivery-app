...
const colorConfig = {
  ...
  success: {
    active: "bg-green",
    activeShadow: "shadow-green/30",
    gradient: "from-green to-green-active",
  },
  warning: {
    active: "bg-status-warning",
    activeShadow: "shadow-status-warning/30",
    gradient: "from-status-warning to-status-warning-active",
  },
  gold: {
    active: "bg-secondary",
    activeShadow: "shadow-secondary/30",
    gradient: "from-secondary to-secondary-active",
  },
};
      ...
      >
        ...
        {showIcons && (
          <>
            ...
            {/* X icon */}
            <motion.span
              className="absolute right-1.5 text-text-muted"
              initial={false}
              animate={
                shouldAnimate
        ...
        <motion.button
          ...
          className={cn(
            ...
            isChecked
              ...
              : "bg-white border-border-strong hover:border-primary/50"
          )}
          whileHover={shouldAnimate && !disabled ? { scale: 1.1 } : undefined}
