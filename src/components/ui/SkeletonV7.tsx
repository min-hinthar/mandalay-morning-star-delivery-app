...
// v7Duration available for future use
...
export interface SkeletonV7Props {
  /** Width of skeleton */
  width?: string | number;
  /** Height of skeleton */
...
const SingleSkeleton = forwardRef<HTMLDivElement, Omit<SkeletonV7Props, "count" | "gap">>(
  (
    {
      width = "100%",
      height = 20,
...
export const SkeletonV7 = forwardRef<HTMLDivElement, SkeletonV7Props>(
...
SkeletonV7.displayName = "SkeletonV7";
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 space-y-2">
            <SkeletonV7 height={18} width="70%" radius="sm" />
            {withAvatar && <SkeletonV7 height={14} width="40%" radius="sm" />}
          </div>
        </div>
        ...
        <div className="flex justify-between items-center pt-2">
          <SkeletonV7 height={14} width="30%" radius="sm" />
          <SkeletonV7 height={32} width={80} radius="lg" />
        </div>
      </div>
    </div>
  );
...
export function SkeletonMenuItem({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="flex-1 space-y-2">
        <SkeletonV7 height={18} width="60%" radius="sm" />
        <SkeletonV7 height={14} width="80%" radius="sm" />
        <div className="flex justify-between items-center pt-1">
          <SkeletonV7 height={20} width={60} radius="sm" />
          <SkeletonV7 height={32} width={32} radius="full" />
        </div>
      </div>
    </div>
  );
