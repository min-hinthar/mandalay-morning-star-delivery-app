...
export function PreferencesSection({ settings, updateField }: PreferencesSectionProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="mt-1 text-sm text-text-secondary">Select any that apply to you</p>
      ...
      <section>
        <h3 className="text-base font-semibold text-text-primary">Default Delivery Instructions</h3>
        <p className="mt-1 text-sm text-text-secondary">Added to every order automatically</p>
        ...
        <div className="mt-4">
          <textarea
            ...
            className="w-full rounded-card-sm border border-border bg-surface-primary px-4 py-3 text-base sm:text-sm text-text-primary placeholder:text-text-tertiary focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus:border-primary resize-none"
          />
