  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-card bg-surface-primary p-5">
        ...
        <p className="mt-1 mb-4 text-sm text-text-secondary">Choose your preferred color scheme</p>
      ...
      <section className="rounded-card bg-surface-primary p-5">
        ...
        <p className="mt-1 mb-4 text-sm text-text-secondary">Adjust text size for readability</p>
        <FontSizeSelector />
      </section>

      {/* Animations */}
      <section className="rounded-card bg-surface-primary p-5">
        <h3 className="text-base font-semibold text-text-primary">Animations</h3>
        ...
        <ToggleSwitch
          ...
          onChange={(checked) => setPreference(checked ? "reduced" : "full")}
      ...
      {/* Sound Effects */}
      <section className="rounded-card bg-surface-primary p-5">
        <h3 className="text-base font-semibold text-text-primary">Sound Effects</h3>
        <p className="mt-1 mb-3 text-sm text-text-secondary">Toggle interaction sounds</p>
        <ToggleSwitch
          id="sound-effects"
          checked={isEnabled}
          onChange={setEnabled}
