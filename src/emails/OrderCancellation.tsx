  ...
  return (
    ...
    >
      ...
      <Section style={{ padding: '32px 24px 0 24px' }}>
        ...
        >
          We&apos;re sorry to see this order go. Your order has been
          cancelled.
        </Text>
      </Section>
      ...
      >
        ...
        <Text style={{ fontSize: '16px', fontFamily: SANS, fontWeight: 700, color: '#111111', margin: '0 0 12px 0' }}>
          <Link href={orderUrl} style={{ color: '#D4A017', textDecoration: 'underline', fontWeight: 700 }}>
            #{shortId}
          </Link>
        </Text>
        ...
        <Text style={{ fontSize: '14px', fontFamily: SANS, color: '#111111', margin: '0 0 12px 0' }}>
            ...
            {items.map((item, idx) => (
              <tr key={idx}>
                <td style={{ padding: '6px 0', borderBottom: '1px solid #F3F4F6' }}>
                  <Text style={{ fontSize: '14px', fontFamily: SANS, color: '#374151', margin: '0' }}>
        ...
        {refundIssued ? (
          ...
          >
            ...
            >
              ...
              {refundMethod || 'original payment method'} within{' '}
          ...
          >
            ...
            >
              No refund has been issued for this order. If you believe this
