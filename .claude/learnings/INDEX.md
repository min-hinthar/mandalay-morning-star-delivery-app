...
| Next.js          | `nextjs.md`           | Route groups not in URL; NEXT_REDIRECT uncatchable; Image aspect ratio; revalidatePath defaults to "page" (use "layout" for context/nav data); **external `<img>` + Google referrer policy fix** | 2026-02-28   |
...
| Data Schema      | `data-schema.md`      | Allergen duplication in tags vs allergens columns; Fuse.js tuning for menu dataset; **PostgREST ambiguous FK hints required for multi-FK tables**           | 2026-03-02   |
